    ...
    const fetchData = async () => {
      try {
        const response = await fetch(
          `${url}inventoryBillsForDate?linkTo=date&equalTo=${formattedDate}`,
          {
            method: "GET",
            mode: "cors",
            headers: {
    ...
    <>
      <section className="sectionRegistreInventory">
        <div className="sectionRegistreInventory--div1">
          <h3>Gastos ya registrados en el día</h3>
          <Compras
        ...
        <div className="sectionRegistreInventory--div2">
          <h3>Registre los gastos del día</h3>
          <form
            className="card-body"
            id="formRegis"
            onSubmit={(e) => {
          ...
          >
            ...
            <div className="mb-3">
              ...
              <textarea
                ...
                placeholder="Aquí puedes ingresar información como detalles del gasto, o novedades."
              />
            </div>
